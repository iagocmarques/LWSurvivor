...
- Game feel effects parametrizados por golpe (dados na hitbox), não hardcoded.
- Buffer global de input ~8 frames (configurável).
- Usar apenas MCP `user-unity-mcp` (não `user-ai-game-developer`).

## Completion Protocol

- Report: o que foi alterado, o que foi verificado, riscos residuais.
- Manter breve.
